...
},{"./..\\..\\images\\jumbotron.jpg":[["jumbotron.104cebb4.jpg","../images/jumbotron.jpg"],"../images/jumbotron.jpg"],"./..\\..\\images\\jumbotron-2.jpg":[["jumbotron-2.32e69707.jpg","../images/jumbotron-2.jpg"],"../images/jumbotron-2.jpg"],"_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/requests.js":[function(require,module,exports) {
"use strict";
...
var request = {
  ...
  fetchDiscoverMovies: function () {
    ...
    /*#__PURE__*/
    regeneratorRuntime.mark(function _callee4(sortBy, year, vote, genres) {
      var request, res;
      return regeneratorRuntime.wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            case 0:
              _context4.next = 2;
              return fetch("https://api.themoviedb.org/3/discover/movie?api_key=".concat(apiKey, "&sort_by=").concat(sortBy, "&year=").concat(year, "&vote_average.gte=").concat(vote, "&with_genres=").concat(genres));
    ...
    function fetchDiscoverMovies(_x, _x2, _x3, _x4) {
...
(function () {
  ...
  _requests.request.fetchPopularMovies().then(function (data) {
    var output = '';
    var genresArray = '';
    data.results.map(function (movie) {
      genresArray = _moviesGenres.genres.filter(function (genre) {
  ...
  _requests.request.fetchPlayingMovies().then(function (data) {
    var output = '';
    var genresArray = '';
    data.results.map(function (movie) {
      genresArray = _moviesGenres.genres.filter(function (genre) {
      ...
      output += "\n\t\t\t\t<div onclick=\"test(".concat(movie.id, ")\" class=\"mr-3 card\" style=\"width: 20rem;\">\n\t\t\t\t    <img class=\"card-img-top card-img\" data-lazy=\"https://image.tmdb.org/t/p/w500").concat(movie.poster_path, "\" alt=").concat(movie.title, ">\n\t\t\t\t    <div class=\"card-body\">\n\t\t\t\t        <h5 class=\"card-title card-movie-title\">").concat(movie.title, "</h5>\n\t\t\t\t        <p class=\"card-text card-details\">").concat(movie.release_date.split("-")[0], " | ").concat(genreOutput, " </p>\n\t\t\t\t    </div>\n      \t\t\t</div>\n\t\t\t\t");
    });
