...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./includes/base.css":"css/includes/base.css","./includes/components.css":"css/includes/components.css","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/onTheAirShows.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  _requests.request.fetchAllPopularShows('on_the_air').then(function (data) {
    var output = '';
    var genresArray = '';
    data.map(function (movie) {
      ...
      output += "\n\t\t\t\t<div onclick=\"o(".concat(movie.id, ")\" class=\"mb-5 mr-3 ml-3 card\" id=").concat(movie.id, " style=\"width: 11rem;\">\n\t\t\t\t\t<img class=\"card-img-lazy card-img\" style=\"height: 16.5rem;\" data-src=\"https://image.tmdb.org/t/p/w500").concat(movie.poster_path, "\" alt=\"Card image cap\">\n\t\t\t\t\t\t<div class=\"card-body\">\n\t\t\t\t\t\t<h5 class=\"card-title card-small-title\">").concat(movie.name, "</h5>\n\t\t\t\t\t\t<p class=\"card-text card-small-details\">").concat(movie.first_air_date.split("-")[0], " | ").concat(genreOutput, "</p>\n\t\t\t\t\t</div>\n\t\t\t\t</div>\n\t\t\t\t");
    });
...
},{}]},{},["../node_modules/parcel-bundler/src/builtins/hmr-runtime.js","js/onTheAirShows.js"], null)
//# sourceMappingURL=/onTheAirShows.382dc8ff.js.map