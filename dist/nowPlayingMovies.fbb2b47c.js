...
// ID-urile fac referita la genul filmului ( info de la TMDB API )
var genres = [{
  id: 28,
  name: "Action"
}, {
...
(function () {
  ...
  _requests.request.fetchAllTypeMovies('now_playing').then(function (data) {
    var output = '';
    var genresArray = '';
