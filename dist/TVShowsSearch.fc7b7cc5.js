...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./includes/base.css":"css/includes/base.css","./includes/components.css":"css/includes/components.css","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/TVShowsSearch.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  var getMovies = function getMovies(movie, page) {
    ...
    if (movie.length > 0) {
      ...
      _requests.request.fetchSearchShows(movie, page).then(function (data) {
