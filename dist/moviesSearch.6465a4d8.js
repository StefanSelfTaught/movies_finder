...
module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./includes/base.css":"css/includes/base.css","./includes/components.css":"css/includes/components.css","_css_loader":"../node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/moviesSearch.js":[function(require,module,exports) {
"use strict";
...
(function () {
  ...
  _requests.request.fetchSearchMoviesDefault().then(function (data) {
    var output = '';
    var genresArray = '';
  ...
  var getMovies = function getMovies(movie, page) {
    ...
    if (movie.length > 0) {
      ...
      _requests.request.fetchSearchMovies(movie, page).then(function (data) {
